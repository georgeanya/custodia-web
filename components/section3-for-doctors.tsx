...
const Section3 = () => {
  return (
    <div className="px-5 md:px-32">
      <div
        className=" md:pt-28 pt-20 md:pb-36 pb-24 container mx-auto"
        id="benefits"
      >
        ...
        <div className="md:mt-6 flex flex-wrap justify-between">
          ...
          <div className="mt-17 sm:max-w-s">
            ...
            <p className="text-base leading-6 md:text-lg md:leading-relaxed text-[#476D85] mt-2">
              With continuous monitoring, we track patient health, allowing us
              to deprescribe medications when necessary.
            </p>
          </div>
          <div className="mt-17 sm:max-w-s">
            ...
            <p className="text-base leading-6 md:text-lg md:leading-relaxed text-[#476D85] mt-2">
              Referring patients is very easy. Simply fill out our referral
          ...
          <div className="mt-17 sm:max-w-s">
            ...
            <p className="text-base leading-6 md:text-lg md:leading-relaxed text-[#476D85] mt-2">
              ...
              interventions. We do not do primary care and our interests are
              100% aligned.
            </p>
          </div>
          <div className="mt-17 sm:max-w-s">
            ...
            <p className="text-base leading-6 md:text-lg md:leading-relaxed text-[#476D85] mt-2">
              Our providers stay in touch with you on relevant patient
              milestones and health changes.
            </p>
          </div>
        </div>
      </div>
